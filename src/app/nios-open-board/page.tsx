          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-[#fca311] rounded-2xl p-8 text-center shadow-2xl">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-[#25D366] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#128C7E] transition-colors shadow-lg mb-6 no-underline"
              >
